...
// Imported from https://bitbucket.org/C3/2d-xna-primitives/wiki/Home
...
namespace Duco_Amoveo
{
    ...
    public static class Primitives2D
    {
        ...
        private static Texture2D CreateThePixel(SpriteBatch spriteBatch)
        {
        ...
        private static List<Vector2> DrawPoints(SpriteBatch spriteBatch, Vector2 position, List<Vector2> points, Color color, float thickness)
        {
            if (points.Count < 2)
                return null;
        ...
        public static List<Vector2> DrawCircle(this SpriteBatch spriteBatch, Vector2 center, float radius, int sides, Color color, float thickness)
        {
            List<Vector2> list = new List<Vector2>();

            list = DrawPoints(spriteBatch, center, CreateCircle(radius, sides), color, thickness);
